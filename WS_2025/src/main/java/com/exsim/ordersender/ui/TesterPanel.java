 ...
 * Main content panel
 */
public class TesterPanel extends JPanel implements Observer, ActionListener {
    ...
    public TesterPanel(OrderTableModel orderTableModel,
                       ExecutionTableModel executionTableModel,
                       OrderSenderApplication application) {
        setName("BanzaiPanel");
